...
output_file = f"./models/model_v1.bin"

features = ["moisture", "quakers", "category_two_defects", \
    "species", "owner", "farm_name", "company", "region", \
...
if __name__ == "__main__":
    ...
    dv, model = train_final_model(df_full_train, y_full_train, c=c, max_iter=max_iter, random_state=random_state)

    y_pred = validate_model(df_test, y_test, dv, model)
    
    print("Final model is: Logistic Regression, with parameters: c={c}, max_iter={max_iter}, random_state={random_state}")
